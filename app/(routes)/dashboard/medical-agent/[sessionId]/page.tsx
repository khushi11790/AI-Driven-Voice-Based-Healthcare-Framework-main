  ...
  return (
    <div className='p-5 border rounded-3xl bg-secondary'>
      <div className='flex justify-between items-center'>
        ...
        <h2 className='font-bold text-xl text-grey-400'>00:00</h2>
      </div>
       {sessionDetail&&<div className='flex items-center flex-col mt-10'>
        <Image src={`/doctor${sessionDetail?.selectedDoctor?.id}.png`} alt={sessionDetail?.selectedDoctor?.specialist??''}
        width={120}
        height={120}
        ...
        {!callStarted?<Button className='mt-20' onClick={StartCall} disabled={loading}>{loading?<Loader className='animate-spin'/>:<PhoneOff/>}Start Call</Button>
